...
saveRDS(dbaExperiment, "/projects/drc_scratch/chipseq_wf/Chipseq_mycn/data/diffbind_exp_r2", compress = TRUE) ##Please share
saveRDS(dbaControl, "/projects/drc_scratch/chipseq_wf/Chipseq_mycn/data/diffbind_cont_r2", compress = TRUE) ##Please share
...
saveRDS(jg.experimentPeakset, "/projects/drc_scratch/chipseq_wf/Chipseq_mycn/data/control_counts_expt_object_r2", compress = TRUE) ##Please share
saveRDS(jg.controlPeakset, "/projects/drc_scratch/chipseq_wf/Chipseq_mycn/data/control_counts_control_object_r2", compress = TRUE) ##Please share
...
saveRDS(jg.controlCountsTreated, "/projects/drc_scratch/chipseq_wf/Chipseq_mycn/data/control_counts_treated_object_r2",compress = TRUE) ##Please share
saveRDS(jg.controlCountsUntreated, "/projects/drc_scratch/chipseq_wf/Chipseq_mycn/data/control_counts_untreated_object_r2", compress = TRUE) ##Please share
...
saveRDS(jg.correctionFactor, "/projects/drc_scratch/chipseq_wf/Chipseq_mycn/data/correctionFactor_object_r2", compress = T) ##Please share
